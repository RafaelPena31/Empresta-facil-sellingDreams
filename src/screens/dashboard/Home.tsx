...
import activeImage from '../../Assets/img/icons/empresta_ativos.png'
        ...
        <ImageBackground resizeMode='cover' source={backgroundImage} style={styles.backgroundImage}>
          <View style={styles.headerContainer}>
            <View style={styles.profileHeader}>
              <Text style={styles.title}>Seja bem vindo, {auth().currentUser?.displayName}</Text>
          ...
          <View style={styles.optionContainer}>
            ...
            <TouchableOpacity
              ...
              <Image style={styles.iconCard} source={activeImage} />

              <Text style={styles.headerText}>ATIVOS</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={styles.touchableItem}
              onPress={() => {
